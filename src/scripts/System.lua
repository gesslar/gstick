...
GStick.EventHandlers.installHandler = registerNamedEventHandler(GStick.appName, "GStickInstall", "sysInstallPackage",
  "GStick:Install")
GStick.EventHandlers.uninstallHandler = registerNamedEventHandler(GStick.appName, "GStickUninstall",
  "sysUninstallPackage", "GStick:Uninstall")
